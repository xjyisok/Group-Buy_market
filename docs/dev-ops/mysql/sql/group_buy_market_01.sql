...
CREATE database if NOT EXISTS `group_buy_market_01` default character set utf8mb4 collate utf8mb4_0900_ai_ci;
use `group_buy_market_01`;
...
DROP TABLE IF EXISTS `group_buy_order_000`;
...
DROP TABLE IF EXISTS `group_buy_order_001`;

CREATE TABLE `group_buy_order_001` (
                                   `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                                   `team_id` varchar(8) NOT NULL COMMENT '拼单组队ID',
                                   `activity_id` bigint NOT NULL COMMENT '活动ID',
                                   `source` varchar(8) NOT NULL COMMENT '渠道',
...
DROP TABLE IF EXISTS `group_buy_order_002`;

CREATE TABLE `group_buy_order_002` (
                                   `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                                   `team_id` varchar(8) NOT NULL COMMENT '拼单组队ID',
                                   `activity_id` bigint NOT NULL COMMENT '活动ID',
                                   `source` varchar(8) NOT NULL COMMENT '渠道',
...
DROP TABLE IF EXISTS `group_buy_order_003`;

CREATE TABLE `group_buy_order_003` (
                                   `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                                   `team_id` varchar(8) NOT NULL COMMENT '拼单组队ID',
                                   `activity_id` bigint NOT NULL COMMENT '活动ID',
                                   `source` varchar(8) NOT NULL COMMENT '渠道',
...
DROP TABLE IF EXISTS `group_buy_order_list_000`;

CREATE TABLE `group_buy_order_list_000` (
                                        `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
...
DROP TABLE IF EXISTS `group_buy_order_list_001`;

CREATE TABLE `group_buy_order_list_001` (
                                        `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                                        `user_id` varchar(64) NOT NULL COMMENT '用户ID',
                                        `team_id` varchar(8) NOT NULL COMMENT '拼单组队ID',
                                        `order_id` varchar(12) NOT NULL COMMENT '订单ID',
...
DROP TABLE IF EXISTS `group_buy_order_list_002`;

CREATE TABLE `group_buy_order_list_002` (
                                        `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                                        `user_id` varchar(64) NOT NULL COMMENT '用户ID',
                                        `team_id` varchar(8) NOT NULL COMMENT '拼单组队ID',
                                        `order_id` varchar(12) NOT NULL COMMENT '订单ID',
...
DROP TABLE IF EXISTS `group_buy_order_list_003`;

CREATE TABLE `group_buy_order_list_003` (
                                            `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                                            `user_id` varchar(64) NOT NULL COMMENT '用户ID',
                                            `team_id` varchar(8) NOT NULL COMMENT '拼单组队ID',
                                            `order_id` varchar(12) NOT NULL COMMENT '订单ID',
...
DROP TABLE IF EXISTS `notify_task_000`;

CREATE TABLE `notify_task_000` (
                               `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                               `activity_id` bigint NOT NULL COMMENT '活动ID',
                               `team_id` varchar(8) NOT NULL COMMENT '拼单组队ID',
...
DROP TABLE IF EXISTS `notify_task_001`;

CREATE TABLE `notify_task_001` (
                                   `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                                   `activity_id` bigint NOT NULL COMMENT '活动ID',
                                   `team_id` varchar(8) NOT NULL COMMENT '拼单组队ID',
                                   `notify_category` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '回调种类',
...
DROP TABLE IF EXISTS `notify_task_002`;

CREATE TABLE `notify_task_002` (
                                   `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                                   `activity_id` bigint NOT NULL COMMENT '活动ID',
                                   `team_id` varchar(8) NOT NULL COMMENT '拼单组队ID',
                                   `notify_category` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '回调种类',
...
DROP TABLE IF EXISTS `notify_task_003`;

CREATE TABLE `notify_task_003` (
                                   `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                                   `activity_id` bigint NOT NULL COMMENT '活动ID',
                                   `team_id` varchar(8) NOT NULL COMMENT '拼单组队ID',
                                   `notify_category` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '回调种类',
